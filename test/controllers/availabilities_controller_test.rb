...
class AvailabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post :create, availability: { question_id: @availability.question_id, restaurant_id: @availability.restaurant_id }
    end
  ...
  test "should update availability" do
    patch :update, id: @availability, availability: { question_id: @availability.question_id, restaurant_id: @availability.restaurant_id }
    assert_redirected_to availability_path(assigns(:availability))
  end
